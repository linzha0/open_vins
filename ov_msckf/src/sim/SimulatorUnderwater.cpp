...
SimulatorUnderwater::SimulatorUnderwater(VioManagerOptions &params_) {
  ...
  PRINT_DEBUG("=======================================\n");
  PRINT_DEBUG("ACOUSTIC-VISUAL-INERTIAL SIMULATOR STARTING\n");
  PRINT_DEBUG("=======================================\n");
...
void SimulatorUnderwater::perturb_parameters(std::mt19937 gen_state, VioManagerOptions &params_) {
...
bool SimulatorUnderwater::get_state(double desired_time, Eigen::Matrix<double, 17, 1> &imustate) {
...
bool SimulatorUnderwater::get_next_imu(double &time_imu, Eigen::Vector3d &wm, Eigen::Vector3d &am) {
...
bool SimulatorUnderwater::get_next_cam(double &time_cam, std::vector<int> &camids,
...
std::vector<std::pair<size_t, Eigen::VectorXf>> SimulatorUnderwater::project_pointcloud(const Eigen::Matrix3d &R_GtoI, const Eigen::Vector3d &p_IinG,
                                                                              int camid,
...
void SimulatorUnderwater::generate_points(const Eigen::Matrix3d &R_GtoI, const Eigen::Vector3d &p_IinG, int camid,
