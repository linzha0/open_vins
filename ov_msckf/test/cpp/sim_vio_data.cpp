...
int main(int argc, char **argv) {
  ...
  while (sim.ok()) {
    ...
    if(sim.get_state(sim_time, state_gt) && save_bag) {
      ...
      bag.write("/ov_msckf/sim_sth/state_gt/pose", ros::Time(state_gt(0, 0)), poseIinG);
      ...
      bag.write("/ov_msckf/sim_sth/state_gt/velocity", ros::Time(state_gt(0, 0)), velocityIinG);
      ...
      bag.write("/ov_msckf/sim_sth/state_gt/bg", ros::Time(state_gt(0, 0)), bg);
      ...
      bag.write("/ov_msckf/sim_sth/state_gt/ba", ros::Time(state_gt(0, 0)), ba);      
    }
